 ...
 *   - /utility      — internal disclosure page (noIndex, disallowed in robots.txt)
...
console.log('  Excluded: /utility (noIndex page), /blog/[slug] (handled via BLOG_SLUGS array above)');
