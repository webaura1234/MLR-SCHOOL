...
export const DOCUMENTS_INFO: DocumentItem[] = [
  ...
  },
  {
    ...
    fileAvailable: true,
    certificateNo: '1907/2004',
    issueDate: '13-12-2004 (Certified True Copy 06-10-2023)',
    validity: 'Registered under A.P. Societies Registration Act, 2001',
    issuingAuthority: 'Registrar of Societies, Hyderabad, Telangana',
  },
  {
    sno: 3,
  ...
  {
    sno: 9,
    documentTitle: 'COPY OF LOCATION CERTIFICATE ISSUED BY THE COMPETENT AUTHORITY',
    documentUrl: '/documents/disclosure/location-certificate.pdf',
    fileAvailable: true,
    certificateNo: 'Lr. No. 2325/C60/CMC/2026',
    issueDate: '15-09-2026',
    validity: 'Issued for school affiliation purpose',
    issuingAuthority: 'Deputy Commissioner, Medchal Circle-60, Cyberabad Municipal Corporation',
  },
  {
    sno: 10,
    documentTitle: 'CERTIFIED STATEMENT / CERTIFICATE ON TOTAL BUILT-UP AREA (BY AUTHORISED / LICENSED ARCHITECT)',
    documentUrl: '/documents/disclosure/built-up-area.pdf',
    fileAvailable: true,
    certificateNo: '26/MRS/2026',
    issueDate: '22-09-2026',
    validity: 'Total Built-up Area 4285.65 Sq.Mtrs (G+4, 33 Classrooms)',
    issuingAuthority: 'P. A. Satish Kumar, COA Reg. No. CA/2017/85123 (Valid till 31-12-2028)',
  },
];
