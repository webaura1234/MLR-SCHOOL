...
export const metadata = constructMetadata({
  ...
  description:
    'Discover life beyond the classroom at Malla Reddy School Medchal — vibrant community, modern campus, student wellness programs, arts, culture, and sports at our CBSE school in Hyderabad.',
  path: '/life',
  keywords: [
    'school life Medchal',
    'campus life Malla Reddy School',
    'student wellness school Hyderabad',
    'CBSE school campus activities Medchal',
